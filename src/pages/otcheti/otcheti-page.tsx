...
import { buttonsInfo } from "@/src/app/configs/otcheti.config";
...
const OtchetiPage = () => {
  ...
  return (
    <div className="px-[15px] xl:px-[130px] py-[60px] xl:py-[80px]">
      <h1 className="text-turquoise-light text-[22px] xl:text-[40px] font-bold leading-[33px] xl:leading-[60px] mb-[30px] xl:mb-[20px] text-center">
        Документы
      </h1>
      <h2 className="text-center mb-[30px] xl:mb-[40px] text-[16px] xl:text-[30px] leading-[27px] xl:leading-[150%] font-bold">
        Отчеты
      </h2>
